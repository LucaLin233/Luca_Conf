# Proxy · Luca 自用脚本配置及简易食用教程
### 如有发现编写错误和个人建议欢迎提issue
### 本仓库之中所有脚本配置纯属自用备份
### 请不要fork，自行同步
# 免责声明
...
### 脚本食用（长按复制链接食用即可）
- [Get Cookies远程重写](https://raw.githubusercontent.com/LucaLin233/Proxy/main/QX/Luca_Get_Cookies.conf)
  ...
  **食用方式如下（在下图中的框框内填入重写链接）**
  ...
  ![](https://github.com/LucaLin233/Proxy/blob/main/Icon/%E9%87%8D%E5%86%99%E9%A3%9F%E7%94%A81.png)
- [Gallery仓库](https://raw.githubusercontent.com/LucaLin233/Proxy/main/QX/Luca_Gallery.json)
  
  **食用方式如下（在下图标记的+号中填入链接仓库链接）**
  
  ![](https://github.com/LucaLin233/Proxy/blob/main/Icon/%E8%84%9A%E6%9C%AC%E9%A3%9F%E7%94%A81.jpg)
- 已引用的大佬脚本如下：
  ...
  - By[@blackmatrix7](https://github.com/blackmatrix7)
    - 滴滴出行系列
- 本仓库脚本建议配合Hello World大佬的京东系列脚本食用，以达到良好的薅羊毛体验（bushi）
...
- [JS重写规则](https://raw.githubusercontent.com/LucaLin233/Proxy/main/QX/Luca_Apps_JS.conf)
- 具体内容自己体验或查看库内代码说明，懂的都懂
### 新增Emby分流规则
[Emby分流](https://raw.githubusercontent.com/LucaLin233/Proxy/main/QX/Luca_Emby.list)
- 包含以下服务器：
  - 普拉斯AGA服务器（中国电信直连使用）
  - CF公益服(仅限挂代理观看)
  - 普拉斯备用服（4个）
