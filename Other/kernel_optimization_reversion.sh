#!/bin/bash
# Linux Kernel Optimization Reversion
# This script reverts the changes made by kernel_optimization.sh
...
# Restore the default or original sysctl.conf settings
...
# Optionally, remove the BBR module if not needed anymore
modprobe -r tcp_bbr &>/dev/null

echo "System settings have been reverted to their original state."
